...
CREATE TABLE vehiculos(
    ...
    combustion ENUM('gasolina', 'diesel', 'hibrido_gasolina', 'hibrido_diesel', 'hibrido_enchufable_gasolina', 'hibrido_enchufable_diesel', 'electrico', 'glp', 'gnc', 'hidrogeno') NOT NULL,
